    ...
    class QuarterlyIncomeReport
    {
        ...
        public void QuarterlySalesReport(SalesData[] salesData)
        {
            ...
            foreach (SalesData data in salesData)
            {
                ...
                // update the profit percentage for the department
                double cumulativeDepartmentProfit = quarterlyProfitByDepartment[quarter][data.departmentName];
                double cumulativeDepartmentSales = quarterlySalesByDepartment[quarter][data.departmentName];
                ...
                // update the profit percentage for the quarter
                double cumulativeQuarterProfit = quarterlyProfit[quarter];
                double cumulativeQuarterSales = quarterlySales[quarter];
